...
//TODO: Test goes here...
    Eras parent1 = new Eras();
    Eras parent2 = new Eras();
    Eras parent3 = new Eras();


    Eras entity = new Eras();
    entity.setStart_date("aaa");
    entity.setEnd_date("bbb");
    parent1.setEras(entity);
    ...
    entity.setStart_date("aaa");
    entity.setEnd_date("");
    parent2.setEras(entity);
    set.add(parent2);

    entity = new Eras();
    entity.setStart_date("");
    entity.setEnd_date("bb");
    parent3.setEras(entity);
    set.add(parent3);

    int size =  CollectionUtils.clearFieldEmptyElement(set,"eras.start_date,eras.end_date");
